  ...
  return (
    <div className="mt-24 flex flex-col items-center">
      ...
      <div className="flex flex-col">
        ...
        <p>In neopub, you don't have an email and password. Your identity is a cryptographic keypair.</p>
        <button onClick={handleCreateIDClicked}>Create ID</button>
        <button onClick={handleLoadIDClicked}>Load ID</button>
        {status}
      </div>
    </div>
  );
